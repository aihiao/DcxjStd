...
public class ObjectUtility
{
    ...
    public static Transform FindChildObject(Transform parent, string name, bool excludeRoot)
    {
        ...
        foreach (Transform child in parent.GetComponentsInChildren(typeof(Transform), true))
        {
            ...
            if (String.Equals(child.gameObject.name, name) == true) // 为了效率区分大小写，有问题资源自己改去
                return child;
        }
    ...
    public static List<Transform> FindChildObjects(Transform parent, string name, bool excludeRoot, bool checkStartWith = false)
    {
