...
namespace ClientCommon
{
	public partial class ConstValue
	{
		...
		public static Dictionary<int, object> ConstValueDict = new Dictionary<int, object>()
		{
			{ConstValueName.AttributeValueAP, AttributeValueAP},
			{ConstValueName.AttributeValueASP, AttributeValueASP},
			{ConstValueName.AttributeValueCDP, AttributeValueCDP},
			{ConstValueName.AttributeValueCP, AttributeValueCP},
			{ConstValueName.AttributeValueCRP, AttributeValueCRP},
			{ConstValueName.AttributeValueDGP, AttributeValueDGP},
			{ConstValueName.AttributeValueHITP, AttributeValueHITP},
			{ConstValueName.AttributeValueHP, AttributeValueHP},
			{ConstValueName.AttributeValueIABP, AttributeValueIABP},
			{ConstValueName.AttributeValueIDP, AttributeValueIDP},
			{ConstValueName.AttributeValueOABP, AttributeValueOABP},
			{ConstValueName.AttributeValueODP, AttributeValueODP},
			{ConstValueName.AttributeValueSP, AttributeValueSP},
			{ConstValueName.AttriubteValueAVOP, AttriubteValueAVOP},
			{ConstValueName.AudioRolloffMaxDistance, AudioRolloffMaxDistance},
			{ConstValueName.AudioRolloffMinDistance, AudioRolloffMinDistance},
			{ConstValueName.BaseRankActiveLevel, BaseRankActiveLevel},
			{ConstValueName.BattleChangeTargetMaxSearchDistance, BattleChangeTargetMaxSearchDistance},
			{ConstValueName.BattleFarawayRoleAttackDistance, BattleFarawayRoleAttackDistance},
			{ConstValueName.BattleMaxDistanceForMoveToEnemyWhenStop, BattleMaxDistanceForMoveToEnemyWhenStop},
			{ConstValueName.BattleNearRoleAttackDistance, BattleNearRoleAttackDistance},
			{ConstValueName.CameraMaxDistance, CameraMaxDistance},
			{ConstValueName.CameraMaxDistanceBattle, CameraMaxDistanceBattle},
			{ConstValueName.CameraMinDistance, CameraMinDistance},
			{ConstValueName.CameraMinDistanceBattle, CameraMinDistanceBattle},
			{ConstValueName.CameraTraceDistance, CameraTraceDistance},
			{ConstValueName.CameraTraceDistanceBattle, CameraTraceDistanceBattle},
			{ConstValueName.CameraXScaleToLoadingOtherPlayerAsset, CameraXScaleToLoadingOtherPlayerAsset},
			{ConstValueName.CameraYScaleToLoadingOtherPlayerAsset, CameraYScaleToLoadingOtherPlayerAsset},
			{ConstValueName.ClickGroundEffectYOffset, ClickGroundEffectYOffset},
			{ConstValueName.CollectDistance, CollectDistance},
			{ConstValueName.CombatFormationRadius, CombatFormationRadius},
			{ConstValueName.CombatReSelectTargetCurrentAddation, CombatReSelectTargetCurrentAddation},
			{ConstValueName.CombatReSelectTargetDistance, CombatReSelectTargetDistance},
			{ConstValueName.ConnectGateServerTimeOutJudgmentTime, ConnectGateServerTimeOutJudgmentTime},
			{ConstValueName.ConstF, ConstF},
			{ConstValueName.DefaultPotentialTargetRange, DefaultPotentialTargetRange},
			{ConstValueName.DistanceToNpcDialog, DistanceToNpcDialog},
			{ConstValueName.DropGravityYAcceleratedSpeed, DropGravityYAcceleratedSpeed},
			{ConstValueName.DropInitYSpeed, DropInitYSpeed},
			{ConstValueName.DropMaxTime, DropMaxTime},
			{ConstValueName.DropMinTime, DropMinTime},
			{ConstValueName.DropRadius, DropRadius},
			{ConstValueName.DungeonGuideArrowVisibleDistance, DungeonGuideArrowVisibleDistance},
			{ConstValueName.KLightUpdateTimeSlice, KLightUpdateTimeSlice},
			{ConstValueName.KUILightUpdateTimeSlice, KUILightUpdateTimeSlice},
			{ConstValueName.MirrorArenaSyncNeedFightAddition, MirrorArenaSyncNeedFightAddition},
			{ConstValueName.MoveSpeedInCity, MoveSpeedInCity},
			{ConstValueName.MusicVolume, MusicVolume},
			{ConstValueName.New1v1ScoreCoefficient, New1v1ScoreCoefficient},
			{ConstValueName.OnHoldingNearDistance, OnHoldingNearDistance},
			{ConstValueName.OnHoldingNearTimeSection, OnHoldingNearTimeSection},
			{ConstValueName.OnHoldingSendPositionDeltaTime, OnHoldingSendPositionDeltaTime},
			{ConstValueName.PvPInnerDamageScaler, PvPInnerDamageScaler},
			{ConstValueName.PvPOuterdamageScaler, PvPOuterdamageScaler},
			{ConstValueName.RunAnimMovementSpeed, RunAnimMovementSpeed},
			{ConstValueName.SoundVolume, SoundVolume},
			{ConstValueName.TeamDungeonRefreshCoolTime, TeamDungeonRefreshCoolTime},
			{ConstValueName.TestFloat, TestFloat},
			{ConstValueName.UnitFollowDistance, UnitFollowDistance},
			{ConstValueName.WorldBossHurtErrantryFactor, WorldBossHurtErrantryFactor},
			{ConstValueName.WorldBossHurtGameMoneyFactor, WorldBossHurtGameMoneyFactor},
			{ConstValueName.WorldBossRankErrantryFactor, WorldBossRankErrantryFactor},
			{ConstValueName.AttributeValueAPColor, AttributeValueAPColor},
			{ConstValueName.AttributeValueASPColor, AttributeValueASPColor},
			{ConstValueName.AttributeValueCDPColor, AttributeValueCDPColor},
			{ConstValueName.AttributeValueCPColor, AttributeValueCPColor},
			{ConstValueName.AttributeValueCRPColor, AttributeValueCRPColor},
			{ConstValueName.AttributeValueDGPColor, AttributeValueDGPColor},
			{ConstValueName.AttributeValueHITPColor, AttributeValueHITPColor},
			{ConstValueName.AttributeValueHPColor, AttributeValueHPColor},
			{ConstValueName.AttributeValueIABPColor, AttributeValueIABPColor},
			{ConstValueName.AttributeValueIDPColor, AttributeValueIDPColor},
			{ConstValueName.AttributeValueOABPColor, AttributeValueOABPColor},
			{ConstValueName.AttributeValueODPColor, AttributeValueODPColor},
			{ConstValueName.AttributeValueSPColor, AttributeValueSPColor},
			{ConstValueName.AttriubteValueAVOPColor, AttriubteValueAVOPColor},
			{ConstValueName.AutoFightUseLevel, AutoFightUseLevel},
			{ConstValueName.BaseRankConditionLevel, BaseRankConditionLevel},
			{ConstValueName.BaseRankConditionLimit, BaseRankConditionLimit},
			{ConstValueName.BaseRankFightValue, BaseRankFightValue},
			{ConstValueName.BaseRankRankSize, BaseRankRankSize},
			{ConstValueName.BattleAvatarTemplateId, BattleAvatarTemplateId},
			{ConstValueName.BattleEndShowingEffectTime, BattleEndShowingEffectTime},
			{ConstValueName.BattleEnvPlayerTemplateId, BattleEnvPlayerTemplateId},
			{ConstValueName.BattlePlayerTemplateId, BattlePlayerTemplateId},
			{ConstValueName.CentryCitySceneId, CentryCitySceneId},
			{ConstValueName.ChatInputMaxCount, ChatInputMaxCount},
			{ConstValueName.ChatListLimitCount, ChatListLimitCount},
			{ConstValueName.CityAvatarTemplateId, CityAvatarTemplateId},
			{ConstValueName.CombatAfterGameEndTimeOutTime, CombatAfterGameEndTimeOutTime},
			{ConstValueName.CombatAllConnectionLosedTimeOutTime, CombatAllConnectionLosedTimeOutTime},
			{ConstValueName.CombatBeforeStartGameTimeOutTime, CombatBeforeStartGameTimeOutTime},
			{ConstValueName.CombatFormationDeltaDegrees, CombatFormationDeltaDegrees},
			{ConstValueName.CombatMultiDungeonTimeLimit, CombatMultiDungeonTimeLimit},
			{ConstValueName.CombatRealTime1v1TimeLimit, CombatRealTime1v1TimeLimit},
			{ConstValueName.CombatWaitOtherPlayerConnectTimeOutTime, CombatWaitOtherPlayerConnectTimeOutTime},
			{ConstValueName.ConcentrateFireAbilityId, ConcentrateFireAbilityId},
			{ConstValueName.CreateAvatarTemplateId, CreateAvatarTemplateId},
			{ConstValueName.DamageTextOffsetY, DamageTextOffsetY},
			{ConstValueName.DartPeriod, DartPeriod},
			{ConstValueName.DefaultWeaponInCityID, DefaultWeaponInCityID},
			{ConstValueName.DefaultWeaponInDungeonID, DefaultWeaponInDungeonID},
			{ConstValueName.DemonstrationBattlePlayerDummyGroupId, DemonstrationBattlePlayerDummyGroupId},
			{ConstValueName.DemonstrationBattlePlayerGirlDummyGroupId, DemonstrationBattlePlayerGirlDummyGroupId},
			{ConstValueName.DialogEableSendLevel, DialogEableSendLevel},
			{ConstValueName.DialogEableSendVipLevel, DialogEableSendVipLevel},
			{ConstValueName.DialogItemLimitCountFaction, DialogItemLimitCountFaction},
			{ConstValueName.DialogItemLimitCountGM, DialogItemLimitCountGM},
			{ConstValueName.DialogItemLimitCountSystem, DialogItemLimitCountSystem},
			{ConstValueName.DialogItemLimitCountTotal, DialogItemLimitCountTotal},
			{ConstValueName.DialogItemLimitCountWorld, DialogItemLimitCountWorld},
			{ConstValueName.DungeonFightConditionAutoHideTime, DungeonFightConditionAutoHideTime},
			{ConstValueName.DungeonGuideArrowRotationSpeed, DungeonGuideArrowRotationSpeed},
			{ConstValueName.DungeonViewerAvatarTemplateId, DungeonViewerAvatarTemplateId},
			{ConstValueName.EmailClientSize, EmailClientSize},
			{ConstValueName.EmailMaxSize, EmailMaxSize},
			{ConstValueName.EquipmentBuyBelt, EquipmentBuyBelt},
			{ConstValueName.EquipmentBuyCloth, EquipmentBuyCloth},
			{ConstValueName.EquipmentBuyHat, EquipmentBuyHat},
			{ConstValueName.EquipmentBuyNecklace, EquipmentBuyNecklace},
			{ConstValueName.EquipmentBuyRing, EquipmentBuyRing},
			{ConstValueName.EquipmentBuyWeapon, EquipmentBuyWeapon},
			{ConstValueName.EquipmentPutonMinLevelBelt, EquipmentPutonMinLevelBelt},
			{ConstValueName.EquipmentPutonMinLevelCloth, EquipmentPutonMinLevelCloth},
			{ConstValueName.EquipmentPutonMinLevelHat, EquipmentPutonMinLevelHat},
			{ConstValueName.EquipmentPutonMinLevelNecklace, EquipmentPutonMinLevelNecklace},
			{ConstValueName.EquipmentPutonMinLevelRing, EquipmentPutonMinLevelRing},
			{ConstValueName.EquipmentPutonMinLevelWeapon, EquipmentPutonMinLevelWeapon},
			{ConstValueName.EquipmentRecastBeginCondition, EquipmentRecastBeginCondition},
			{ConstValueName.EquipmentRefineBeginCondition, EquipmentRefineBeginCondition},
			{ConstValueName.EquipmentRefineMaxLevel, EquipmentRefineMaxLevel},
			{ConstValueName.EquipmentReinforceBeginCondition, EquipmentReinforceBeginCondition},
			{ConstValueName.EquipmentSlotCount, EquipmentSlotCount},
			{ConstValueName.Errantry, Errantry},
			{ConstValueName.Exp, Exp},
			{ConstValueName.FastCleanDungeon, FastCleanDungeon},
			{ConstValueName.FirstAcupointId, FirstAcupointId},
			{ConstValueName.FirstFakeBattleSceneId, FirstFakeBattleSceneId},
			{ConstValueName.FriendsBlessDailyCount, FriendsBlessDailyCount},
			{ConstValueName.FriendsBlessGainStaminCount, FriendsBlessGainStaminCount},
			{ConstValueName.FriendsCdTime, FriendsCdTime},
			{ConstValueName.FriendsChatLimitCount, FriendsChatLimitCount},
			{ConstValueName.FriendShipUpLimit, FriendShipUpLimit},
			{ConstValueName.FriendsLimitCount, FriendsLimitCount},
			{ConstValueName.FriendsMsgCount, FriendsMsgCount},
			{ConstValueName.FriendsPushLevel, FriendsPushLevel},
			{ConstValueName.GameMoney, GameMoney},
			{ConstValueName.GrowthFundBuyNeedRealMoney, GrowthFundBuyNeedRealMoney},
			{ConstValueName.GrowthFundBuyNeedVip, GrowthFundBuyNeedVip},
			{ConstValueName.HeartPowerActiveLevel, HeartPowerActiveLevel},
			{ConstValueName.HeroFightMaxNum, HeroFightMaxNum},
			{ConstValueName.IdleOnceTimeSection, IdleOnceTimeSection},
			{ConstValueName.InitialAttributeLevel, InitialAttributeLevel},
			{ConstValueName.InitRankGradId, InitRankGradId},
			{ConstValueName.InvalidConfigValue, InvalidConfigValue},
			{ConstValueName.LeagueApplyCount, LeagueApplyCount},
			{ConstValueName.LeagueCreateLevel, LeagueCreateLevel},
			{ConstValueName.LeagueCreateRealMoney, LeagueCreateRealMoney},
			{ConstValueName.LeagueInviteCD, LeagueInviteCD},
			{ConstValueName.LeagueMaxLevel, LeagueMaxLevel},
			{ConstValueName.LootExpItemId, LootExpItemId},
			{ConstValueName.LootMoneyItemId, LootMoneyItemId},
			{ConstValueName.LootRealMoneyItemId, LootRealMoneyItemId},
			{ConstValueName.LootReputationItemId, LootReputationItemId},
			{ConstValueName.MatrixCentreSlotCount, MatrixCentreSlotCount},
			{ConstValueName.MaxComeOnFxCount, MaxComeOnFxCount},
			{ConstValueName.MaxConfigHint, MaxConfigHint},
			{ConstValueName.MaxInScreenShowingAvatarCount, MaxInScreenShowingAvatarCount},
			{ConstValueName.MaxLevel, MaxLevel},
			{ConstValueName.MaxStamina, MaxStamina},
			{ConstValueName.MirrorArenaBattleClearCoolCost, MirrorArenaBattleClearCoolCost},
			{ConstValueName.MirrorArenaBattleCoolTime, MirrorArenaBattleCoolTime},
			{ConstValueName.MirrorArenaBattleCount, MirrorArenaBattleCount},
			{ConstValueName.MirrorArenaBattleCountDownTime, MirrorArenaBattleCountDownTime},
			{ConstValueName.MirrorArenaBattleLimitTime, MirrorArenaBattleLimitTime},
			{ConstValueName.MirrorArenaBattleRecordCount, MirrorArenaBattleRecordCount},
			{ConstValueName.MirrorArenaBattleSceneId, MirrorArenaBattleSceneId},
			{ConstValueName.MirrorArenaBuyBattleCountCost, MirrorArenaBuyBattleCountCost},
			{ConstValueName.MirrorArenaEachDayRewardCount, MirrorArenaEachDayRewardCount},
			{ConstValueName.MirrorArenaNormalRefreshCost, MirrorArenaNormalRefreshCost},
			{ConstValueName.MirrorArenaNormalRefreshCount, MirrorArenaNormalRefreshCount},
			{ConstValueName.MirrorArenaNormalRefreshRange, MirrorArenaNormalRefreshRange},
			{ConstValueName.MirrorArenaVipRefreshCost, MirrorArenaVipRefreshCost},
			{ConstValueName.MirrorArenaVipRefreshRange, MirrorArenaVipRefreshRange},
			{ConstValueName.MonsterCreaterTemplateId, MonsterCreaterTemplateId},
			{ConstValueName.MonsterPatrolIdleMs, MonsterPatrolIdleMs},
			{ConstValueName.MonthcardBuyCountLimit, MonthcardBuyCountLimit},
			{ConstValueName.MultiDungeonMaxShowGroupCount, MultiDungeonMaxShowGroupCount},
			{ConstValueName.MultiDungeonResetAwardCount, MultiDungeonResetAwardCount},
			{ConstValueName.NameMaxLength, NameMaxLength},
			{ConstValueName.New1v1ArenaSceneId, New1v1ArenaSceneId},
			{ConstValueName.New1v1FirstCombatDummyId, New1v1FirstCombatDummyId},
			{ConstValueName.New1v1FixPerTime, New1v1FixPerTime},
			{ConstValueName.New1v1FloorEmailId, New1v1FloorEmailId},
			{ConstValueName.New1v1FloorScore, New1v1FloorScore},
			{ConstValueName.New1v1LoseScore, New1v1LoseScore},
			{ConstValueName.New1v1MatchTime, New1v1MatchTime},
			{ConstValueName.New1v1PerTimeFixLevel, New1v1PerTimeFixLevel},
			{ConstValueName.New1v1RankMinScore, New1v1RankMinScore},
			{ConstValueName.New1v1SceneId, New1v1SceneId},
			{ConstValueName.New1v1WinScore, New1v1WinScore},
			{ConstValueName.NpcCollectionTemplateId, NpcCollectionTemplateId},
			{ConstValueName.NpcTemplateId, NpcTemplateId},
			{ConstValueName.NullDataValue, NullDataValue},
			{ConstValueName.OnevsoneArenaCooldown, OnevsoneArenaCooldown},
			{ConstValueName.OnevsoneArenaLimitTime, OnevsoneArenaLimitTime},
			{ConstValueName.OnevsoneArenaMatchRangeFix, OnevsoneArenaMatchRangeFix},
			{ConstValueName.OnevsoneArenaMatchTimeMax, OnevsoneArenaMatchTimeMax},
			{ConstValueName.OnevsoneArenaMatchTimeNormal, OnevsoneArenaMatchTimeNormal},
			{ConstValueName.OnevsoneArenaMaxRecord, OnevsoneArenaMaxRecord},
			{ConstValueName.OnevsoneArenaOpenEmail, OnevsoneArenaOpenEmail},
			{ConstValueName.OnevsoneArenaRankShow, OnevsoneArenaRankShow},
			{ConstValueName.OnevsoneArenaSceneId, OnevsoneArenaSceneId},
			{ConstValueName.OnevsoneArenaScoreInit, OnevsoneArenaScoreInit},
			{ConstValueName.OnevsoneArenaScoreMax, OnevsoneArenaScoreMax},
			{ConstValueName.OnevsoneArenaScoreMin, OnevsoneArenaScoreMin},
			{ConstValueName.OnevsoneArenaSeasonDuration, OnevsoneArenaSeasonDuration},
			{ConstValueName.OnevsoneArenaStraightBroadcast, OnevsoneArenaStraightBroadcast},
			{ConstValueName.OnevsOneCanMeetDummyCount, OnevsOneCanMeetDummyCount},
			{ConstValueName.OneVsOneClearCoolTimeCost, OneVsOneClearCoolTimeCost},
			{ConstValueName.OnevsOneOpenNextSeasonBreakTime, OnevsOneOpenNextSeasonBreakTime},
			{ConstValueName.OpenChangeHero, OpenChangeHero},
			{ConstValueName.OpenFriends, OpenFriends},
			{ConstValueName.OpenHeartPower, OpenHeartPower},
			{ConstValueName.OpenHire, OpenHire},
			{ConstValueName.OpenJewelCompose, OpenJewelCompose},
			{ConstValueName.OpenRealm, OpenRealm},
			{ConstValueName.OpenStore, OpenStore},
			{ConstValueName.OpenTimeLimitDungeon, OpenTimeLimitDungeon},
			{ConstValueName.OpenTreasure, OpenTreasure},
			{ConstValueName.OpenTutor, OpenTutor},
			{ConstValueName.OpenWorldChatLevel, OpenWorldChatLevel},
			{ConstValueName.OpenWorldChatVIPLevel, OpenWorldChatVIPLevel},
			{ConstValueName.PropertyRateDivisionFactor, PropertyRateDivisionFactor},
			{ConstValueName.RandomMissionCanDoneCount, RandomMissionCanDoneCount},
			{ConstValueName.RandomMissionReceiveCount, RandomMissionReceiveCount},
			{ConstValueName.RandomMissionRefreshApart, RandomMissionRefreshApart},
			{ConstValueName.RandomMissionRefreshCost, RandomMissionRefreshCost},
			{ConstValueName.RandomMissionRefreshCount, RandomMissionRefreshCount},
			{ConstValueName.RandomMissionRefreshFree, RandomMissionRefreshFree},
			{ConstValueName.RandomMissionRefreshTimesLimit, RandomMissionRefreshTimesLimit},
			{ConstValueName.RealMoney, RealMoney},
			{ConstValueName.RealTime1v1BattleCountDownTime, RealTime1v1BattleCountDownTime},
			{ConstValueName.ReConnectAutoActionCutdownTime, ReConnectAutoActionCutdownTime},
			{ConstValueName.RedPacketsDailyPickCount, RedPacketsDailyPickCount},
			{ConstValueName.RenameItemId, RenameItemId},
			{ConstValueName.Repution, Repution},
			{ConstValueName.ResourceFloatingTextInterval, ResourceFloatingTextInterval},
			{ConstValueName.RoleGameMoneyMax, RoleGameMoneyMax},
			{ConstValueName.ServiceControl, ServiceControl},
			{ConstValueName.SignGoToNpcId, SignGoToNpcId},
			{ConstValueName.SkillViewerBattleAvatarTemplateId, SkillViewerBattleAvatarTemplateId},
			{ConstValueName.StaminaId, StaminaId},
			{ConstValueName.StaminaRecoverInterval, StaminaRecoverInterval},
			{ConstValueName.StaminaRecoverQuantity, StaminaRecoverQuantity},
			{ConstValueName.StoreBlackRefreshCost, StoreBlackRefreshCost},
			{ConstValueName.StoreBlackUnlock, StoreBlackUnlock},
			{ConstValueName.StoreDeluxeBlackRefreshCost, StoreDeluxeBlackRefreshCost},
			{ConstValueName.StoreDeluxeBlackUnlock, StoreDeluxeBlackUnlock},
			{ConstValueName.StoreNormalRefreshCost, StoreNormalRefreshCost},
			{ConstValueName.StoreNormalUnlock, StoreNormalUnlock},
			{ConstValueName.StoreRefreshCountResetDayOfWeek, StoreRefreshCountResetDayOfWeek},
			{ConstValueName.StoryCompaignFightTimes, StoryCompaignFightTimes},
			{ConstValueName.TalkContentRefreshTimeSecond, TalkContentRefreshTimeSecond},
			{ConstValueName.TalkForbidEndTimeSecond, TalkForbidEndTimeSecond},
			{ConstValueName.TalkNoForbidVipLevel, TalkNoForbidVipLevel},
			{ConstValueName.TimeLimitDungeonEmail, TimeLimitDungeonEmail},
			{ConstValueName.TimeLimitDungeonFailedLimit, TimeLimitDungeonFailedLimit},
			{ConstValueName.TimeLimitDungeonFirstDefaultId, TimeLimitDungeonFirstDefaultId},
			{ConstValueName.TimeLimitDungeonMax, TimeLimitDungeonMax},
			{ConstValueName.TimeLimitDungeonRankCount, TimeLimitDungeonRankCount},
			{ConstValueName.TotemNotDamageableTemplateId, TotemNotDamageableTemplateId},
			{ConstValueName.TowerBattleTimesEachDay, TowerBattleTimesEachDay},
			{ConstValueName.TowerFreeRefreshCount, TowerFreeRefreshCount},
			{ConstValueName.TowerGoldRefreshCost, TowerGoldRefreshCost},
			{ConstValueName.TowerRefreshTime, TowerRefreshTime},
			{ConstValueName.TrialBossFailedRefreshMoney, TrialBossFailedRefreshMoney},
			{ConstValueName.TrialBossKilledRefreshMoney, TrialBossKilledRefreshMoney},
			{ConstValueName.TrialCount, TrialCount},
			{ConstValueName.TrialFailedCooldown, TrialFailedCooldown},
			{ConstValueName.TrialKillCombatCooldown, TrialKillCombatCooldown},
			{ConstValueName.UIPnlUseBoxMaxNum, UIPnlUseBoxMaxNum},
			{ConstValueName.UIRoleInfoIgnoreCastingTime, UIRoleInfoIgnoreCastingTime},
			{ConstValueName.UIRoleInfoIgnoreControlledTime, UIRoleInfoIgnoreControlledTime},
			{ConstValueName.VoiceDialogEnableLength, VoiceDialogEnableLength},
			{ConstValueName.VoiceDialogEnableMaxLength, VoiceDialogEnableMaxLength},
			{ConstValueName.WorldBossBattleCD, WorldBossBattleCD},
			{ConstValueName.WorldBossBattleCDClearCost, WorldBossBattleCDClearCost},
			{ConstValueName.WorldBossBattleSence, WorldBossBattleSence},
			{ConstValueName.WorldBossBattleTimeLimit, WorldBossBattleTimeLimit},
			{ConstValueName.WorldBossBeforeBattleTime, WorldBossBeforeBattleTime},
			{ConstValueName.WorldBossDefaultBossId, WorldBossDefaultBossId},
			{ConstValueName.WorldBossLastRankNum, WorldBossLastRankNum},
			{ConstValueName.WorldBossPrepareBattleSence, WorldBossPrepareBattleSence},
			{ConstValueName.WorldBossPrepareBattleTimeLimit, WorldBossPrepareBattleTimeLimit},
			{ConstValueName.WorldBossPrepareMaxNum, WorldBossPrepareMaxNum},
			{ConstValueName.WorldBossPrepareMinParticipant, WorldBossPrepareMinParticipant},
			{ConstValueName.WorldBossStoreRefreshCost, WorldBossStoreRefreshCost},
			{ConstValueName.WorldChatCDTime, WorldChatCDTime},
			{ConstValueName.WorldMapAnimLimitLevel, WorldMapAnimLimitLevel},
			{ConstValueName.WorldMapInertiaReduceFrames, WorldMapInertiaReduceFrames},
			{ConstValueName.AutoFightEffect, AutoFightEffect},
			{ConstValueName.AvatarInformationMenu, AvatarInformationMenu},
			{ConstValueName.AvatarMoveEffectName, AvatarMoveEffectName},
			{ConstValueName.BackBuildingModeName, BackBuildingModeName},
			{ConstValueName.BackBuildingPos, BackBuildingPos},
			{ConstValueName.BagPages, BagPages},
			{ConstValueName.BaseRankRefreshWeeklyTime, BaseRankRefreshWeeklyTime},
			{ConstValueName.CentryCityName, CentryCityName},
			{ConstValueName.ChatMessageSelfColor, ChatMessageSelfColor},
			{ConstValueName.ClickGroundEffect, ClickGroundEffect},
			{ConstValueName.ClientEquipmentLevelUpSuccessEffect, ClientEquipmentLevelUpSuccessEffect},
			{ConstValueName.ClientEquipmentStarUpFailedEffect, ClientEquipmentStarUpFailedEffect},
			{ConstValueName.ClientTreasureDescomposeSuccessEffect, ClientTreasureDescomposeSuccessEffect},
			{ConstValueName.ClientTreasureRepairedFailedEffect, ClientTreasureRepairedFailedEffect},
			{ConstValueName.ClientTreasureRepairedSuccessEffect, ClientTreasureRepairedSuccessEffect},
			{ConstValueName.ClientTreasureSelectedEffect, ClientTreasureSelectedEffect},
			{ConstValueName.CollectItemText, CollectItemText},
			{ConstValueName.CollectResourceText, CollectResourceText},
			{ConstValueName.DailyBenefitEffect, DailyBenefitEffect},
			{ConstValueName.DailyBenefitNpcId, DailyBenefitNpcId},
			{ConstValueName.DailyMissionLivenessAndReward, DailyMissionLivenessAndReward},
			{ConstValueName.DailyMissionRefreshTime, DailyMissionRefreshTime},
			{ConstValueName.DamageParticleBone, DamageParticleBone},
			{ConstValueName.DamageTextAbsorb, DamageTextAbsorb},
			{ConstValueName.DamageTextBlock, DamageTextBlock},
			{ConstValueName.DamageTextDurDamageEnemy, DamageTextDurDamageEnemy},
			{ConstValueName.DamageTextDurDamageHero, DamageTextDurDamageHero},
			{ConstValueName.DamageTextDurHeal, DamageTextDurHeal},
			{ConstValueName.DamageTextHeal, DamageTextHeal},
			{ConstValueName.DamageTextHealCritical, DamageTextHealCritical},
			{ConstValueName.DamageTextMiss, DamageTextMiss},
			{ConstValueName.DamageTextReduce, DamageTextReduce},
			{ConstValueName.DamageTextReflect, DamageTextReflect},
			{ConstValueName.DamageTextSkill, DamageTextSkill},
			{ConstValueName.DamageTextSkillCritical, DamageTextSkillCritical},
			{ConstValueName.DamageTextSkillInterrupted, DamageTextSkillInterrupted},
			{ConstValueName.DamageTextWeapon, DamageTextWeapon},
			{ConstValueName.DamageTextWeaponCritical, DamageTextWeaponCritical},
			{ConstValueName.DartDescription, DartDescription},
			{ConstValueName.DungeonGuideArrowResName, DungeonGuideArrowResName},
			{ConstValueName.DungeonResetTime, DungeonResetTime},
			{ConstValueName.EmailDefaultSender, EmailDefaultSender},
			{ConstValueName.EmailDefaultSenderIcon, EmailDefaultSenderIcon},
			{ConstValueName.ExchangePage, ExchangePage},
			{ConstValueName.FriendsBlessMessage, FriendsBlessMessage},
			{ConstValueName.GemComposeSuccessEffect, GemComposeSuccessEffect},
			{ConstValueName.GoodsYuanBao, GoodsYuanBao},
			{ConstValueName.GoodsYueKa, GoodsYueKa},
			{ConstValueName.GoodsZengSong, GoodsZengSong},
			{ConstValueName.GraduateHigh, GraduateHigh},
			{ConstValueName.GraduateMiddle, GraduateMiddle},
			{ConstValueName.GraduatePrimary, GraduatePrimary},
			{ConstValueName.IDamageFormula, IDamageFormula},
			{ConstValueName.KShaderMixFactorName, KShaderMixFactorName},
			{ConstValueName.LeagueBossDungeonOpenTime, LeagueBossDungeonOpenTime},
			{ConstValueName.LevelUpEffect, LevelUpEffect},
			{ConstValueName.LightFactorByTime, LightFactorByTime},
			{ConstValueName.LoginAndSelectAreaMusicName, LoginAndSelectAreaMusicName},
			{ConstValueName.LootDropHeapCountPercent, LootDropHeapCountPercent},
			{ConstValueName.MentalTypeUpEffect, MentalTypeUpEffect},
			{ConstValueName.MirrorArenaBattleResetTime, MirrorArenaBattleResetTime},
			{ConstValueName.MirrorArenaDefaultDummyGroupRank, MirrorArenaDefaultDummyGroupRank},
			{ConstValueName.MirrorArenaEachWeekRewardCalcTime, MirrorArenaEachWeekRewardCalcTime},
			{ConstValueName.MonsterCreaterActiveWaveAnimClip, MonsterCreaterActiveWaveAnimClip},
			{ConstValueName.MonsterCreaterActiveWaveByOtherDeath, MonsterCreaterActiveWaveByOtherDeath},
			{ConstValueName.MonsterCreaterIdleAnimClip, MonsterCreaterIdleAnimClip},
			{ConstValueName.New1v1LevelSection, New1v1LevelSection},
			{ConstValueName.New1v1LevelSubtractScore, New1v1LevelSubtractScore},
			{ConstValueName.New1v1OpenTimeRange, New1v1OpenTimeRange},
			{ConstValueName.New1v1SendRewardTime, New1v1SendRewardTime},
			{ConstValueName.ODamageFormula, ODamageFormula},
			{ConstValueName.OnevsoneArenaChallengeTime, OnevsoneArenaChallengeTime},
			{ConstValueName.OnevsoneArenaScoreFix, OnevsoneArenaScoreFix},
			{ConstValueName.OnevsOneDummyDetail, OnevsOneDummyDetail},
			{ConstValueName.OnevsOneMeetDummyCountRefreshTime, OnevsOneMeetDummyCountRefreshTime},
			{ConstValueName.PlayerGuideList, PlayerGuideList},
			{ConstValueName.QualityColorFive, QualityColorFive},
			{ConstValueName.QualityColorFour, QualityColorFour},
			{ConstValueName.QualityColorOne, QualityColorOne},
			{ConstValueName.QualityColorThree, QualityColorThree},
			{ConstValueName.QualityColorTwo, QualityColorTwo},
			{ConstValueName.QualityColorZero, QualityColorZero},
			{ConstValueName.RandomMissionResetTime, RandomMissionResetTime},
			{ConstValueName.RoleDefaultShader, RoleDefaultShader},
			{ConstValueName.RoleLevelRewardDetail, RoleLevelRewardDetail},
			{ConstValueName.RoleOutLineShader, RoleOutLineShader},
			{ConstValueName.SelectDungonBGM, SelectDungonBGM},
			{ConstValueName.SelectedAura, SelectedAura},
			{ConstValueName.SkillLevelUpEffect, SkillLevelUpEffect},
			{ConstValueName.StaminaBuyResetTime, StaminaBuyResetTime},
			{ConstValueName.StoreBlackDailyRefreshTime, StoreBlackDailyRefreshTime},
			{ConstValueName.StoreCommonDailyRefreshTime, StoreCommonDailyRefreshTime},
			{ConstValueName.StoreDailyRefreshTime, StoreDailyRefreshTime},
			{ConstValueName.StoreDeluxeBlackRefreshTime, StoreDeluxeBlackRefreshTime},
			{ConstValueName.TestString, TestString},
			{ConstValueName.TextSkillEffect, TextSkillEffect},
			{ConstValueName.TextSkillNextLevelEffect, TextSkillNextLevelEffect},
			{ConstValueName.TextSkillNextTypeEffect, TextSkillNextTypeEffect},
			{ConstValueName.TimeLimitDungeonDesc, TimeLimitDungeonDesc},
			{ConstValueName.TimeLimitDungeonEmailContent, TimeLimitDungeonEmailContent},
			{ConstValueName.TimeLimitDungeonRefreshTime, TimeLimitDungeonRefreshTime},
			{ConstValueName.TimeZone, TimeZone},
			{ConstValueName.TitleBlock, TitleBlock},
			{ConstValueName.TrialRefreshTime, TrialRefreshTime},
			{ConstValueName.UILightFactorByTime, UILightFactorByTime},
			{ConstValueName.UIMainMenuButtons, UIMainMenuButtons},
			{ConstValueName.UIPnlAnnouncementAnnouncementURL, UIPnlAnnouncementAnnouncementURL},
			{ConstValueName.UIPnlSignInAlreadySignLabel, UIPnlSignInAlreadySignLabel},
			{ConstValueName.WorldBossDuration, WorldBossDuration},
			{ConstValueName.WorldBossPrepareDuration, WorldBossPrepareDuration},
			{ConstValueName.WorldBossStoreRefreshTime, WorldBossStoreRefreshTime},
			{ConstValueName.TestDouble, TestDouble},
		};
	}
}
